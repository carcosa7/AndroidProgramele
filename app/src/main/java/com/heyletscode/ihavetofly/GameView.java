...
public class GameView extends SurfaceView implements Runnable {
    ...
    public GameView(GameActivity activity, int screenX, int screenY) {
        ...
        sound = soundPool.load(activity, R.raw.shootsound, 1);
    ...
    private void update () {
        ...
        for (Rock rock : rocks) {
            ...
            if (rock.x + rock.width < 0) {
                ...
                if (rock.speed < 10 * screenRatioX)
                    rock.speed = (int) (10 * screenRatioX);
    ...
    private void draw () {
        ...
        if (getHolder().getSurface().isValid()) {
            ...
            for (Rock rock : rocks)
                canvas.drawBitmap(rock.getBird(), rock.x, rock.y, paint);
